...
export const metadata: Metadata = {
  ...
  title: {
    default: "Website Laten Maken Veldhoven & Eindhoven | RoTech Development",
    template: "%s | RoTech Development",
  },
  description: "Website laten maken in Veldhoven of Eindhoven? RoTech Development is uw lokale webdesigner in Noord-Brabant. ✓ Persoonlijk contact ✓ Vanaf €997 ✓ Snelle oplevering. Vraag gratis offerte aan!",
  keywords: [
    ...
    "professionele website eindhoven",
    "website op maat brabant",
    "web development eindhoven",
    "SEO optimalisatie veldhoven",
    "bedrijfswebsite laten maken brabant",
  ],
  alternates: {
